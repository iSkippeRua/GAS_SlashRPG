...
void UHeroGameplayAbility_TargetLock::OnTargetLockTick(float DeltaTime)
{
	...
	const bool bShouldOverrideRotation = !USlashFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), GAS_SlashGameplayTags::Player_Status_Rolling) &&
		!USlashFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), GAS_SlashGameplayTags::Player_Status_Blocking);
...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
	...
	if(InSwitchDirectionTag == GAS_SlashGameplayTags::Player_Event_SwitchTarget_Left)
	{
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
	if(!DrawnTargetLockWidget)
	{
		...
		DrawnTargetLockWidget = CreateWidget<USlashWidgetBase>(GetHeroControllerFromActorInfo(), TargetLockWidgetClass);
