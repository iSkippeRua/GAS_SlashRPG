...
void UInv_InventoryComponent::TryAddItem(UInv_ItemComponent* ItemComponent)
{
	...
	if (Result.Item.IsValid() && Result.bIsStackable)
	{
		...
		Server_AddStackToItem(ItemComponent, Result.TotalRoomToFill, Result.RemainedItems);
	}
	else if (Result.TotalRoomToFill > 0)
	{
		Server_AddNewItem(ItemComponent, Result.bIsStackable ? Result.TotalRoomToFill : 0, Result.RemainedItems);
	}
}

void UInv_InventoryComponent::Server_AddNewItem_Implementation(UInv_ItemComponent* ItemComponent, int32 StackCount, int32 RemainedItems)
{
	...
	{
		StackableFragment->SetStackCount(RemainedItems);
	}
}

void UInv_InventoryComponent::Server_AddStackToItem_Implementation(UInv_ItemComponent* ItemComponent, int32 StackCount, int32 RemainedItems)
{
...
void UInv_InventoryComponent::SpawnDroppedItem(UInv_InventoryItem* DroppedItem, int32 StackCount)
{
	...
	FInv_ItemManifest& ItemManifest = DroppedItem->GetItemManifestMutable();
