...
UCLASS()
class INVENTORYSYSTEMPLUGIN_API UInv_InventoryItem : public UObject
{
	GENERATED_BODY()
...
private:
	UPROPERTY(VisibleAnywhere, meta = (BaseStruct = "/Script/InventorySystemPlugin.Inv_ItemManifest"), Replicated)
