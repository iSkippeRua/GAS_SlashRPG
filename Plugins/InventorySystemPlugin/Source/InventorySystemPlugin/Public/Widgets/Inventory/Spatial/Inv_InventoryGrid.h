...
UCLASS()
class INVENTORYSYSTEMPLUGIN_API UInv_InventoryGrid : public UUserWidget
{
	GENERATED_BODY()
...
private:
	...
	void ChangeHoverType(const int32 Index, const FIntPoint& Dimensions, EInv_GridSlotState HoverType);
	...
	void SwapStackCounts(const int32 ClickedItemStackCount, const int32 HoveredItemStackCount, const int32 Index);

	bool ShouldConsumeHoverItemStacks(const int32 HoveredStackCount, const int32 RoomInClickedSlot) const;

	void ConsumeHoverItemStacks(const int32 ClickedItemStackCount, const int32 HoveredItemStackCount, const int32 Index);
